...
function analyzeAudio(jsn){
    var runPyScript = "test"
    // get path of the current script
    var scriptPath = cs.getSystemPath(SystemPath.EXTENSION);
...
function procAud(){
    ...
    if (ppAudio.checked) {ppAb = true} else {ppAb = false}
